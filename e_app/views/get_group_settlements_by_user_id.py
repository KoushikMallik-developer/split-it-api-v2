...
class GetGroupSettlementsByUserId(APIView):
    ...
    def get(self, request: Request):
        try:
            ...
            if validate_user_uid(uid=user_id).is_validated:
                result = SettlementService().get_group_settlements_by_user(
                    data=GetGroupSettlementsRequestType(**request.data), uid=user_id
                )
                return Response(
                    data={
