    ...
    def get_searched_users(
        ...
        try:
            ...
            if validate_email_format(keyword):
                ...
                users = User.objects.filter(query, is_deleted=False)[:10]
